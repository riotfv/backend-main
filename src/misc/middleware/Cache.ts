...
class Cache<Key, Value> {
  ...
  private async preloadData() {
    const preloadDataList: Array<{ key: Key; value: Value; ttl: number }> = [
      { key: "freebob:1" as Key, value: { id: 1, name: "FreeBob" } as Value, ttl: 3600000 },
      { key: "freebob:2" as Key, value: { id: 2, name: "PoorBob" } as Value, ttl: 86400000 },
      {
        key: "bobby:1" as Key,
...
const cacheClass = new Cache<string, any>(5000);
